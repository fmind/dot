...
Cloud-agent delegation and local CLI execution have different environments. [GitHub Agentic Workflows](../../../../github-actions/references/github-agentic-workflow/GUIDE.md) owns repository workflow authoring; the CLI SDK and ACP links above cover embedding the harness.

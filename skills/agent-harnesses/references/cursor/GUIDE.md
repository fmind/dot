---
name: cursor
description: "Cursor sessions and integration."
---
...
1. Inspect skills through Cursor's Skills interface and MCP through the installed `cursor-agent mcp --help`, `list`, and `list-tools` commands. [agent-project](../../../agent-project/SKILL.md) owns shared discovery; [mcp-setup](../../../mcp-setup/SKILL.md) owns registration.

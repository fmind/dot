---
name: copier
description: Create and update reusable project templates with Copier, the default for new templates. Use when authoring scaffolds or propagating template changes while preserving project edits.
license: MIT
metadata:
  author: Médéric HURIER (Fmind)
  source: github.com/fmind/dot/tree/main/skills/copier
  created: "2026-09-16"
  updated: "2026-09-16"
---
...
Copier is the default for new project templates we maintain. Keep existing Cookiecutter templates and `.cruft.json` projects on [Cookiecutter/Cruft](../cookiecutter/SKILL.md) unless migration is explicitly requested; the formats and update baselines are not interchangeable. [new-project](../new-project/SKILL.md) owns the generated project's stack and repository setup.

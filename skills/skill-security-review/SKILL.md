...
description: "Review third-party skills and agent extensions for supply-chain risk before trusting them."
license: MIT
metadata:
  kind: task
...
- [Agent Skills specification](https://agentskills.io/specification) · [gitleaks](../security-review/references/gitleaks.md) · [trivy](../security-review/references/trivy/GUIDE.md)
...
- Companion skills: [vendor-skill policy](../agent-project/references/vendor-skills.md) (install after review), [security-review](../security-review/references/code-review/GUIDE.md) (repository scans), [threat-model](../threat-model/SKILL.md) (attack paths beyond scanners).

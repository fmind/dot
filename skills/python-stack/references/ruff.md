---
name: ruff
description: "Python linting, formatting, imports, and safe fixes."
---
...
Upstream: [astral-sh/claude-code-plugins](https://github.com/astral-sh/claude-code-plugins), `plugins/astral/skills/ruff`, selection `ruff`. Follow the shared [vendor-skill policy](../../agent-project/references/vendor-skills.md) and compare this local guide before installation.

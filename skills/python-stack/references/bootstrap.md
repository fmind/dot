...
1. **Initialize** the package:
   ```bash
   uv init --lib --build-backend uv --vcs none --python <major.minor> --description "<description>" <slug>
   cd <slug>
   ```
...
1. **Add project files**: [mise.toml](mise.toml), [lefthook.yml](lefthook.yml), [gitignore](gitignore) as `.gitignore`, and [AGENTS.md](AGENTS.md); configure dprint through [dprint](../../dprint/SKILL.md). Fill the README and license through [repository-docs](../../repository-docs/SKILL.md) and [project-license](../../project-license/SKILL.md) before building.

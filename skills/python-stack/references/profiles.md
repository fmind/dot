...
| Data, ML, notebooks | Extend the library foundation with only the required workload dependencies; use [pandas](../../pandas/SKILL.md) or [polars](../../polars/SKILL.md) for DataFrames, [pandera](../../pandera/SKILL.md) for data schemas, [duckdb](../../duckdb/SKILL.md) for queries, [plotly](../../plotly/SKILL.md) for charts, and [marimo](../../marimo/SKILL.md) for reactive notebooks. Put imported runtime dependencies in the package dependencies and development-only tools in dependency groups. |

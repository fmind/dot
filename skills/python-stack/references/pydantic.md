...
Use Pydantic for typed input boundaries and serialization; use [python-stack](foundation/GUIDE.md) for shared project defaults and the selected application skill for scaffolding.

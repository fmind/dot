...
1. **Repository and IaC**: run `check:scan` per [trivy](../trivy/GUIDE.md) for vulnerabilities, misconfiguration, secrets, and licenses. Fix or justify every `HIGH` or `CRITICAL` finding.

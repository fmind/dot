...
1. **Version and evaluate**: prepare [prompt-candidate.md](references/prompt-candidate.md), test on development cases, and use [agent-evaluation](../agent-evaluation/SKILL.md) for adoption evidence before changing production.

---
name: dot-cli
description: Use the dot CLI (fmind/dot) to verify the environment, pull repositories, archive agent sessions and usage, manage dotfiles, or prune caches. Use for any dot command.
license: MIT
metadata:
...
- Companion skills: [agent-usage](../agent-usage/SKILL.md) (token accounting behind `dot agent usage`), [reclaim-disk](../reclaim-disk/SKILL.md) (prune flow), [mise](../mise/SKILL.md) (`mise run deploy`).

...
1. **Make the call**: `LAUNCH`, `LIMIT EXPOSURE`, or `HOLD`, with evidence, blockers, reversible next step, and owner. Validate a segment or willingness to pay with the bounded sales and pricing experiment in [demand-tests](demand-tests.md).

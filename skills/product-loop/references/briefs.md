...
For a substantial or cross-cutting change, produce every section. For a compact, low-risk change, combine or omit immaterial sections but always retain the decision summary, goals and non-goals, identified requirements, acceptance and edge cases, relevant data and trust boundaries, and assumptions or open decisions.

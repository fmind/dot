...
1. **Design the cheapest decisive test**: behavior to observe, segment, exposure, time box, success threshold, guardrail, and kill criterion; prefer commitments over compliments (see [demand-tests](demand-tests.md)).

...
Keep secret variables in `secrets.enc.env` as `TF_VAR_<name>=...` lines and run `sops exec-env secrets.enc.env 'tofu plan'`; state-side encryption is handled by [terraform](../../infra-as-code/SKILL.md).

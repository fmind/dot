...
- **Immutable images**: validate and scan the published Buildx digest, generate its CycloneDX SBOM, then sign, verify, attest, and verify the attestation with [trivy](../../../security-review/references/trivy/GUIDE.md) and [cosign](../../../containerize/references/cosign.md).

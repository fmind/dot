---
name: dependabot
description: "Automated dependency updates and grouping."
---
...
1. **Validate**: `zizmor --offline --collect dependabot --strict-collection .` checks the schema and audits the file offline (see [zizmor](zizmor.md)); GitHub re-validates on push and shows errors in the Dependabot tab.

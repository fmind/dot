---
name: d2
description: "D2 sources, standalone layouts, theming, and exports."
---
...
- **Native rendering**: switch to [mermaid](mermaid.md) when the source must render inside GitHub Markdown.
...
- Companion skills: [fmind-visuals](../../fmind-visuals/SKILL.md) (tool choice and brand), [mermaid](mermaid.md) (default diagrams), [playwright](../../playwright/SKILL.md) (rasterizing SVG).

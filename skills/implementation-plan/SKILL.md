...
Design the smallest sequence of independently verifiable vertical slices that satisfies accepted requirements; [plan-review](../plan-review/SKILL.md) challenges the plan, while implementation follows the accepted scope and applicable stack skills.

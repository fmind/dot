...
1. **Pick the tier**: `gcloud run deploy` for one service; [service.yaml](../templates/service.yaml) via `gcloud run services replace` once settings accumulate; [terraform](../../infra-as-code/SKILL.md) for a fleet.

---
name: marimo
description: "Create, debug, convert, and export reactive marimo Python notebooks and apps, including agent pairing."
---
...
- Companion skills: [python-stack](../../python-stack/references/foundation/GUIDE.md), [agent-project](../../agent-project/SKILL.md), [duckdb](../../duckdb/SKILL.md).

## Data and compute

Preserve dataset provenance and reproducibility. Account access or available quota does not authorize paid compute, submissions, or publication.

- [Kaggle](../../kaggle/SKILL.md): competition data, kernels, and submissions.
- [Colab](../../colab/SKILL.md): accelerator sessions and remote execution.
- [Hugging Face](../../hf/SKILL.md): Hub models, datasets, and jobs.

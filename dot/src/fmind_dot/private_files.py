...
def safe_agent_fs_available() -> bool:
...
def open_or_create_directory_at(parent: int, name: str, mode: int, *, enforce_mode: bool = True) -> int:
...
def publish_owner_only_at(directory: int, name: str, content: bytes) -> None:
